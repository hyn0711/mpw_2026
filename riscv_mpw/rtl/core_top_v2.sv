...
module core_top_v2 #(
    ...
    if (FPGA == 0) begin
        // IMEM (12 -> 13-bit)
        logic [12:0] imem_addr_0;
        logic [12:0] imem_addr_1;
        logic [12:0] imem_addr_2;
        logic [12:0] imem_addr_3;
        logic [7:0] dout_0;
        logic [7:0] dout_1;
        logic [7:0] dout_2;
        logic [7:0] dout_3;
        assign imem_addr_0 = imem_addr[14:2] + |imem_addr[1:0];
        assign imem_addr_1 = imem_addr[14:2] + imem_addr[1];
        assign imem_addr_2 = imem_addr[14:2] + &imem_addr[1:0];
        assign imem_addr_3 = imem_addr[14:2];
        ...
        sram_2048w_32b M2_0 (
            ...
            .A              (buf_addr_0[12:2]),       // 11-bit address
            .D              (buf_wr_data_0),
            .EMA            (3'b000),
            .RETN           (1'b1),
            // outputs
