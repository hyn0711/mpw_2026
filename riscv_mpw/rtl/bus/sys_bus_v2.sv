module sys_bus_v2 (
    ...
    // ---------------- Address Map (new) ----------------
    // IMEM : [0x1000_0000, 0x1000_8000)
    // DMEM : [0x1000_8000, 0x1000_C000)
    localparam logic [31:0] IMEM_BASE = 32'h1000_0000;
    localparam logic [31:0] IMEM_END  = 32'h1000_8000; // exclusive
    localparam logic [31:0] DMEM_BASE = 32'h1000_8000;
    localparam logic [31:0] DMEM_END  = 32'h1000_C000; // exclusive
